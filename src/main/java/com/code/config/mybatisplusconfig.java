...
public class mybatisplusconfig {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/haos?useSSL=false&serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf-8");
        ...
        strategy.setInclude("haddress","admin","hcheck","hotel","hphoto","review","roomsum","roomtype","user","userorder");//设置要映射的表名,只需改这里即可
